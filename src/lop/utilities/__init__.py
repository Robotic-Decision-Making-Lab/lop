...
from .FakeFunction import FakeFunction, FakeLinear, FakeSquared, FakeLogistic, FakeSinExp, FakeWeightedMax, FakeWeightedMin, FakeSquaredMinMax, FakeStaticSin, FakeMixtureGaussian, FakeIntegrate, FakeMinLog
