...
do
    ...
    do
        ...
        do
            python3 single_experiment.py --env $i_env --model gp --selector $selc --sel_type choose1 --num_runs $number_runs --num_alts 4 --user perfect --hyper $hyper_sel --fake_func $fake_func --test_experiment true &
        done
        wait
    done
done
