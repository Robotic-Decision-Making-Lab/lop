...
for selc in SW_ACQ_SPEAR MUTUAL_INFO ACQ_RHO RANDOM ACQ_SPEAR UCB SW_ACQ_LL ACQ_LL #MUTUAL_INFO UCB RANDOM ABS_ACQ_RHO SW_ACQ_LL ACQ_LL ABS_ACQ_LL SW_ACQ_SPEAR ACQ_SPEAR ABS_ACQ_SPEAR  # SW_ACQ_RHO ABS_ACQ_RHO
do
